  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route exact path="/diagnosis/:page?" render={props => <Home {...props} />} />
      </Switch>
      <Switch>
        <Redirect exact from="/board" to="/board/info" exact />
        <Route exact path="/board/:page?" render={props => <BoardMain {...props} />} />
        <Route exact path="/board/info/:page?" render={props => <InfoBoardContent {...props} />} />
        <Route exact path="/board/free/:page?" render={props => <FreeBoardContent {...props} />} />
      </Switch>
      <Switch>
        <Redirect exact from="/diagnosis" to="/diagnosis/search" exact />
        <Route exact path="/diagnosis/search/:page?" render={props => <DiseaseSearch {...props} />} />
        <Route exact path="/diagnosis/qna/:page?" render={props => <QnABoard {...props} />} />
      </Switch>
