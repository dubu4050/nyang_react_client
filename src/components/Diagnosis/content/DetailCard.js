                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} sm container>
                        <Grid item xs container direction="column" spacing={2}>
                            ...
                            <Grid item>
                                <Typography variant="body2" className={classes.writer} gutterBottom>
                                    dubu4050
                </Typography>
                                <Typography variant="body2" className={classes.writerInfo} color="textSecondary" >
                                    @dubu4050 고양이 키워본적 없습니다.
                </Typography>
                            </Grid>
                        </Grid>
                        <Grid item>
                            <Typography variant="subtitle1" className={classes.date}>2021.02.24</Typography>
                        </Grid>
                    </Grid>
                </Grid>
            </Paper>
